...
% plot the writing
Screen('DrawText', window, 'Wir prüfen jetzt, ob Sie sich die Bilder, die Ihnen der Versuchsleiter', textX, textY,[0 0  0]);
Screen('DrawText', window, 'gezeigt hat, gut gemerkt haben.', textX, textY+textSpace);
Screen('DrawText', window, 'Wenn Sie die Bilder nocheinmal sehen möchten, drücken Sie "B"', textX, textY+2*textSpace);
...
Screen('DrawText', window, 'Drücken Sie eine beliebige Taste um fortzufahren', textX, textY+9*textSpace);
% present
Screen('Flip', window);
