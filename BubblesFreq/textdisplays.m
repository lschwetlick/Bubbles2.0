classdef textdisplays
    ...
    methods
        ...
        function obj=Instructions(obj,t)
            ...
            DrawFormattedText(obj.window, t,obj.textX,obj.textY,0,obj.wrap,0,0, 2);
        ...
        function obj=Pause(obj, right, pause)
            obj.ScreenValues();
            rightstr= num2str(right);
            pausestr= num2str(pause);
            t=['In diesem Block haben Sie ', rightstr,' aus ',pausestr,' richtig erkannt.\n\nSie können jetzt eine Pause machen\n\nWeiter mit der Maustaste.'];
            DrawFormattedText(obj.window, t,obj.textX,obj.textY,0,obj.wrap,0,0, 2);
            Screen('Flip', obj.window);
        end
